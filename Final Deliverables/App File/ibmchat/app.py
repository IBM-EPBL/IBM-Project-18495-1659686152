...
def new_student():
    ...
    message = Mail(from_email="premkumar070302@gmail.com",to_emails="pk740879@gmail.com",subject="Account Registered Successfully",html_content="<p>Your account has been created using you provided email address.</p>")
